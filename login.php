  ...
  if (empty($_POST['username']) || empty($_POST['password'])) {
    ...
    if ($_SESSION['errors']==null) {
      ...
      if ($loggedIn!=false) {
        ...
        $_SESSION['userData'] = $loggedIn;
        header("location:index.php");
        exit("Rokan Chowdhury Onick was here...");
      }else{
        $_SESSION['errorsDB'] = "Invalid login!";
      }
    }
  }
}
           ...
           <div class="content">
               ...
               <form action="" method="post">
                 <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
                   ...
                   <input type="text" class="form-control rounded-xs" id="c1" placeholder="Username" name="username" />
